...
int main() {
    ...
    estoque.adicionaProduto(ProdutoEstoque("telefone", 1550, 300));
    estoque.adicionaProduto(ProdutoEstoque("teclado", 370, 50));
    estoque.adicionaProduto(ProdutoEstoque("mouse", 350, 50));
